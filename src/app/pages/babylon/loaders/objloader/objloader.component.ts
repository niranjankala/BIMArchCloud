...
@Component({
  selector: 'bac-babylon-objloader',
  styleUrls: ['./objloader.component.scss'],
  templateUrl: './objloader.component.html',
})
export class BabylonObjLoaderComponent implements OnInit, AfterViewInit {
  engine: any;
  scene: any;
  ...
  ngAfterViewInit() {
    ...
    var createScene = () => {
      ...
      BABYLON.SceneLoader.ImportMesh('', '/assets/files/models/BLIS_SmallOfficeBldg/', 'BLIS_SmallOfficeBldg.obj', scene, (meshes) => {
